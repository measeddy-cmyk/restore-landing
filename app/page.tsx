      ...
      <section style={{ padding: "80px 24px", maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
          {[
            ...
            <div key={i} style={{ padding: "24px", backgroundColor: "var(--card)", border: "1px solid var(--border)", borderRadius: "12px", display: "flex", gap: "16px" }}>
      ...
      <section style={{ padding: "80px 24px", maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          {[
            ...
            <div key={i} style={{ display: "flex", gap: "24px", alignItems: "flex-start", padding: "28px 0", borderBottom: "1px solid var(--border)" }}>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
            {[
              ...
              <div key={i} style={{ padding: "28px", backgroundColor: "var(--card)", border: "1px solid var(--border)", borderRadius: "12px" }}>
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "48px", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            {[
              ...
              <div key={i} style={{ padding: "24px 28px", backgroundColor: "var(--card)", border: "1px solid var(--border)", borderRadius: "12px" }}>
      ...
      <section style={{ padding: "80px 24px", maxWidth: "700px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          {[
            ...
            <div key={i} style={{ display: "flex", gap: "14px", padding: "18px 20px", backgroundColor: "var(--card)", border: "1px solid var(--border)", borderRadius: "10px" }}>
